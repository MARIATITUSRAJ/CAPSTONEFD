            ...
            <div className="container pt-2 text-md-start">
              <div className="row align-items-center justify-content-start">
                <div className="col-lg-3 col-md-6 col-sm-12 mx-auto mb-2">
                  ...
                  <p>
                    At Giant Power, we revolutionize refueling with our
                ...
                <div className="col-lg-3 col-md-6 col-sm-12 mx-auto mb-2">
                  ...
                  <Link
                    to="mailto:titusraj30@gmail.com"
                    target="_new"
                    className="text-white text-decoration-none"
                  >
                    <p>
                      <i className="fas fa-envelope mr-3"></i>
                      <span className="px-2">titusraj30@gmail.com</span>
                    </p>
                  </Link>
                  ...
                  >
                    <p>
                      ...
                      <span className="px-2">+91 8870680839</span>
                    </p>
                  </Link>
                </div>
              </div>
