  ...
  const iconCards = [
    {
      ...
      title: "Reliability",
      paragraph:
        "GiantPower ensures that users can count on their booked gas slots being available when they arrive. Our system is designed to minimize overbooking and guarantee.",
    },
    {
    ...
    },
    {
      ...
      paragraph:
        "GiantPower offers real-time updates on gas station availability, wait times, and booking confirmations. This ensures users have the most accurate information.",
    },
    {
      icon: "fa-solid fa-shield text-primary px-2",
      title: "Safety and Hygiene",
      paragraph:
        "GiantPower partners with gas stations that adhere to the highest safety and hygiene standards. This ensures a clean and secure environment for users.",
    },
    {
      icon: "fa-solid fa-globe text-primary px-2",
      title: "Wide Network",
      paragraph:
        "With a broad network of partnered gas stations, GiantPower offers extensive coverage, ensuring users can find and book slots at convenient locations.",
    },
    {
      icon: "fa-solid fa-indian-rupee-sign text-primary px-2",
      title: "Transparent Pricing",
      paragraph:
        "GiantPower offers transparent pricing, with no hidden fees or unexpected charges. Users can trust that the price they see is the price they pay.",
    },
  ];
